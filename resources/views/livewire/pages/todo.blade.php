            ...
            <div aria-live="assertive" class="fixed inset-0 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start z-10">
                ...
                <div class="max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden">
                    ...
                    <div class="flex items-start">
                        ...
                        <button wire:click="$set('salvo', false)" type='button' class="bg-white rounded-md inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            ...
            <div class="space-y-8 divide-y divide-gray-200">
                <div>
                    ...
                    {{-- <div wire:loading.delay wire:target='store'
                        class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-3 py-6">
                        <x-grid.col size='2'>
                    ...
                    <div wire:target='store'
                        class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-3 justify-items-start items-end">
                        <x-grid.col class='w-full'>
            ...
            @foreach($todos as $todo)
                <tr>
                    ...
                    <td class="hidden md:table-cell px-6 py-3 whitespace-nowrap text-sm text-gray-500 text-right">
                        <button type="button" class="order-1 ml-3 inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:order-0" wire:click="newEventDois({{ $todo->id }})">
                            New event 2
                        </button>
                    </td>
                    ...
                    <div x-data="{ isOpen: false }" class="relative flex justify-end items-center">
                        ...
                        <div class="py-1" role="none">
                            <a href="#" class="text-gray-700 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="project-options-menu-0-item-3" wire:click="delete({{ $todo->id }})">
